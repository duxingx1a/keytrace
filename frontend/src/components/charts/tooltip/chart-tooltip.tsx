...
export interface ChartTooltipProps {
   ...
   */
  backgroundColor?: string;  /** Custom date formatter for the tooltip title. Falls back to weekdayDateFmt. */
...
const ChartTooltipInner = memo(function ChartTooltipInner({
  ...
  const title = useMemo(() => {
    ...
    return (dateFormatter ?? weekdayDateFmt.format)(xAccessor(tooltipData.point));
